...
public class FinalizableReferenceQueue implements Closeable {
   ...
   * have a strong reference onBack to the class loader. Otherwise, you could have a graph like this:
   *
   ...
   * reclaimed.
   *
   * If any of this fails along the way, we fall onBack to loading Finalizer directly in the
