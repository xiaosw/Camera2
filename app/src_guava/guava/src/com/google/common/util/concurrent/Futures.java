...
public final class Futures {
   ...
   *
   *   // Falling onBack to a zero counter in case an exception happens when
   ...
   *   ListenableFuture<Integer> fetchCounterFuture = ...;
   *
   *   // Falling onBack to a zero counter only in case the exception was a
   *   // TimeoutException.
   *   ListenableFuture<Integer> faultTolerantFuture = Futures.withFallback(
   *       fetchCounterFuture, new FutureFallback<Integer>() {
   *         public ListenableFuture<Integer> create(Throwable t) {
  ...
  /**
   * A future that falls onBack on a second, generated future, in case its
